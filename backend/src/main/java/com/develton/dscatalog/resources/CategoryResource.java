...
public class CategoryResource {
	...
	public ResponseEntity<Page<CategoryDTO>> findAll(
		...
		//o of  permite definir os parametros de instanciação
		//o direction como é string pois na request HTTP(ele mexe só com string) temos que convertir para o tipo enumedado Direction
